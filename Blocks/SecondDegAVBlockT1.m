...
% D = 85;%126;   %always add the td part again 
% D3 = 85;%126;
td = 8;%22;%39.5;
tp = 4;%10;%15;9
tq = 1;
...
%input to enter the BPM 
D  = 32;%99.5;   %always add the td part again 
D3 = 32;%99.5;
...
while(D < 1000)
    while(td > 0)
        ...
        D5 = D1+D3;
      for I = D1:D3:D5    % for the next 10 second
        tpq = temp1;
        td  = temp2;
        fs1 = p_wave(tp, td, tpq, tq, Ap);
        plot(x+I,fs1,'-k','linewidth',1);
      end
      D = D3+D5;
end
...
for I=D3:D3:1000
     if I == D3 * Dr
        ...
        for k=1:300
         ...
         fs2 = fs2 +a1/2;
         plot(x+D1+Tinp,fs2,'-k','linewidth',1);
         Dr = Dr + 4;
     else 
        fs2 = q_wave(tq, tr, Aq, Ar); %function call for q wave 
...
td =  td  - temp3/2;                                                                              %To remove the overlaping.
...
title('Second Degree AV Block Morbitz Type I,(Wenckebach)');
